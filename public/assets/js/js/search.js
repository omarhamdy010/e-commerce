              ...
              <div class="product-thumbnail">
                ...
                <div class="pr-info-area">
                  <div data-select="`+products[i].id+`" class="pr-button">
                    ...
                    <div  data-compare="compare" id="`+products[i].id+`" onclick="addTocompare(this.id)" class="mt-button add_to_compare"> <a> <i class="fa fa-signal"></i> </a> </a></div>
                    <div id="`+products[i].id+`" onclick="removeTocompare(this.id)" class="mt-button  remove">  <a> <i class="fa fa-close"></i> </a></div>

                                                ...
                                                <div class="item-inner">
                                                    ...
                                                    <div class="item-info">
                                                        <div class="info-inner">
                                                            <div class="item-title"><a title="Ipsums Dolors Untra" href="single_product.html">{{$product->title}} </a>
                                                            </div>
                                                            <div class="item-content">
                                                                ...
                                                                <div class="pro-action">
                                                                    <button type="button" data-id="{{$product->id}}" class="add-to-cart"><span> Add to Cart</span>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="block shop-by-side">
                            ...
                            <div class="block-content">
                                ...
                                <div id="other_product">
                                    <div class="main-area">
                                        <h2 class="saider-bar-title">MainCategory
                                        </h2>
                                    ...
                                    <div class="layered-Category">
                                        ...
                                        <div class="layered-content">
                                            <ul class="check-box-list" id="shop-catego">
                                                <!-- <li>
                                    ...
                                    <!-- <div class="sort-area">
                                      <h2 class="saider-bar-title">Sort By</h2>
                                      <div class="sort">
                                        <ul id="sort">
                                        <div>
                                         <input name="sort" type="radio" value="Name"/>
                                         <label>Name</label>
                                        </div>
                                        <div>
                                         <input name="sort" type="radio" value="Low to hight"/>
                                         <label>Low to hight</label>
                                        </div>
                                        <div>
                                         <input name="sort" type="radio" value="Low to hight"/>

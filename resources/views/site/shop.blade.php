                ...
                <div class="row">
                    ...
                    <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
                                    ...
                                    <ul class="children">
                                            ...
                                            <ul class="children">
                                                ...
                                                <li class="cat-item cat-parent"><a href="shop_grid.html"><i
                                                    ...
                                                    <ul class="children">
                                                        ...
                                                        <li class="cat-item"><a href="shop_grid.html"><i
                                                                    class="fa fa-angle-right"></i>&nbsp; Sling
                                                                bag</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="cat-item cat-parent"><a href="shop_grid.html"><i
                                            ...
                                            <ul class="children">
                                                ...
                                                <li class="cat-item"><a href="shop_grid.html"><i
                                                            class="fa fa-angle-right"></i>&nbsp; Fabric Handbags</a>
                                                </li>
                                                <li class="cat-item"><a href="shop_grid.html"><i
                                        ...
                                        <div class="layered-content">
                                            <ul class="check-box-list">
                                                @foreach($categories as $category)
                                                    <a id="category_filter" data-id="{{$category->id}}">
                                                        <li>{{$category->name}}</li>
                                                    </a>
                                                @endforeach
                                            </ul>
                        ...
                        <div class="block product-price-range ">
                            ...
                            <div class="block-content">
                                <div class="slider-range">
                                    ...
                                    <div id="range" class="amount-range-price">Range: 10 - 550</div>
                                    <!-- <ul class="check-box-list">
                                      <li>
                                        <input type="checkbox" id="p1" name="cc" />
                                        <label for="p1"> <span class="button"></span> 20EGP - 50EGP<span class="count">(0)</span> </label>
                                      </li>
                                      <li>
                                        <input type="checkbox" id="p2" name="cc" />
                                        <label for="p2"> <span class="button"></span> 50EGP - 100EGP<span class="count">(0)</span> </label>
                                      </li>
                                      <li>
                                        <input type="checkbox" id="p3" name="cc" />
                                        <label for="p3"> <span class="button"></span> 100EGP - 250EGP<span class="count">(0)</span> </label>
                                      </li>
                                    </ul> -->
                                </div>
                            </div>
                        ...
                        <div class="block sidebar-cart">
                            ...
                            <div class="block-content">
                                <p class="amount" id="yourNumb"></p>
                                <ul id="cart">
                                    @if(\Illuminate\Support\Facades\Session::has('cart'))
                                        @foreach(\Illuminate\Support\Facades\Session::get('cart') as $cart)
                                            <li>
                                                <ol class="cart_product"><a href="#"><img
                                                            src="{{asset('uploads/products/'.$cart['image'])}}"
                                                            alt="Product"></a></ol>
                                                <ol class="cart_description"><p class="product-name"><a
                                                            href="#">{{$cart['description']}} </a></p></ol>
                                                <ol class="title"><span>{{$cart['title']}}</span></ol>
                                                <ol class="price"><span>{{$cart['price']}}</span></ol>
                                                <ol class="qty"><input class="form-control input-sm" type="text"
                                                                       value="{{$cart['quantity']}}"></ol>
                                                <ol class="action" id="rremove"><a class="remove_item"><i
                                                            class="fas fa-window-close"></i><input type="hidden"
                                                                                                   value="{{$cart['id']}}"
                                                                                                   id="delete"></a></ol>
                                            </li>
                                        @endforeach
                                ...
                                <div class="cart-checkout">
                                    <button class="button button-checkout" title="Submit" type="submit"><a
                        ...
                        <!-- <div class="block compare">
                          ...
                          <div data-select="sel" class="block-content">
                            <ol id="compare-items">
                            ...
                            <div class="ajax-checkout">
                              ...
                              <button onclick="clearAll()" type="submit" title="Submit" class="button button-clear"> <span>Clear All</span></button>
                            </div>
                          </div>
                        </div> -->
